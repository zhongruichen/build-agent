...
class MainPanel {
    ...
    static createOrShow(context, eventEmitter) {
        ...
        const panel = vscode.window.createWebviewPanel(MainPanel.viewType, 'Multi-Agent Status', column || vscode.ViewColumn.Two, {
            enableScripts: true,
    ...
    constructor(panel, extensionPath, eventEmitter) {
        ...
        this.disposables.push(this.panel.webview.onDidReceiveMessage(async (/** @type {any} */ message) => {
...
MainPanel.currentPanel = undefined;
MainPanel.viewType = 'multiAgentStatus';
module.exports = {
    MainPanel
};
