 ...
 * @param {string} relativePath The path relative to the workspace root.
 * @param {import('../agents/codebaseScannerAgent').CodebaseScannerAgent} scannerAgent An instance of CodebaseScannerAgent.
...
async function summarizeFile(relativePath, scannerAgent) {
    try {
        ...
        return `Error summarizing file: ${error instanceof Error ? error.message : String(error)}`;
    }
}
module.exports = {
    writeFile,
