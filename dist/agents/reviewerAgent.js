        ...
        try {
            ...
            if (jsonMatch && jsonMatch[1]) {
                try {
                    ...
                    throw new Error(`Failed to parse review from LLM response, even after finding JSON block. Error: ${parseError instanceof Error ? parseError.message : String(parseError)}`);
                }
            }
            throw new Error(`Failed to parse review from LLM response. Error: ${e instanceof Error ? e.message : String(e)}`);
        }
    }
}
